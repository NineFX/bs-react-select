...
module SelectJS = {
  ...
  external make :
    (
      ...
      ~menuRenderer: menuRendererProps('a) => React.element=?, /* Renders a custom menu with options; accepts the following named parameters */
      ...
      ~value: Option.t('a)=?,
      /* initial field value */
      ~valueComponent: React.element=?, /* function which returns a custom way to render/manage the value selected <CustomValue /> */
